...
CREATE TABLE `t_avis` (
  ...
  PRIMARY KEY (`PK_Avis`),
  KEY `fk_T_Avis_T_Users_idx` (`FK_UsersUsers`),
  CONSTRAINT `fk_T_Avis_T_Users` FOREIGN KEY (`FK_UsersUsers`) REFERENCES `t_users` (`PK_Users`)
...
INSERT INTO `t_avis` VALUES (1,'Jaime ce filme grosse chlague',12,1),(2,'Ma maman a bien aimé',13,1);
...
INSERT INTO `t_users` VALUES (1,'Matteo','1');
...
-- Dump completed on 2023-04-27 14:27:06
