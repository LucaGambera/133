...
const API_URL = BASE_URL2 + '/discover/movie?sort_by=popularity.desc&' + API_KEY + '&language=fr-FR';

const searchURL = BASE_URL2 + '/search/movie?' + API_KEY + '&language=fr-FR';
...
class Ctrl_film {
    ...
    */
    ...
    start() {
        ...
        wrk_film.getMovies(BASE_URL + "?action=getFilms&PAGE=1");
